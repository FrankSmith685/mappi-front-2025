...
import { SET_ACCESSTOKEN, SET_ACTIVE_INICIAR_SESION_RESENA, SET_AUTHLOGINFORM, SET_AUTHREGISTERFORM, SET_CATEGORIA, SET_CATEGORIA_SELECCIONADA, SET_CHANGE_PASSWORD_TOKEN, SET_COMPANY, SET_DEPARTAMENTOS, SET_DIRECCIONSERVICE, SET_DISTRITOS, SET_FILTRO_AVISOS, SET_ID_AVISO, SET_IDS_DElETE_MULTIMEDIA, SET_IS_ARCHIVADO, SET_IS_EXPANDED, SET_IS_SERVICE_EDIT, SET_IS_SHOW_FILTER_SERVICE, SET_LISTA_AVISOS, SET_LOADING_USER, SET_LOGOUT, SET_MENU_OPEN, SET_MENU_OPEN_USER, SET_MODAL, SET_MODAL_RESENA, SET_MODE, SET_MODELOGIN, SET_MODIFIEDCOMPANY, SET_MODIFIEDSERVICE, SET_MODIFIEDUSER, SET_MULTIMEDIA_AVISOS_PREVIEW, SET_MULTIMEDIASERVICE, SET_NEW_INMUEBLE, SET_PROFILE_TYPE, SET_PROGRESS_PRINCIPAL_PROPERTY, SET_PROGRESS_PRINCIPAL_SERVICE, SET_PROGRESS_PROPERTY, SET_PROGRESS_SERVICE, SET_PROVINCIAS, SET_REFRESHTOKEN, SET_REGISTERUSER, SET_SELECCIONADOS_AVISOS, SET_SELECTED_PERFIL, SET_SERVICE, SET_SERVICIO_SELECCIONADO, SET_SERVICIOS_ACTIVOS, SET_SERVICIOS_FILTER_ACTIVOS, SET_SUBCATEGORIA, SET_TYPE_USER_AUTH, SET_UBIGEO_USUARIO, SET_USER, type ActionTypes } from "../types/actionTypes";
...
export const appReducer = (state: AppState, action: ActionTypes): AppState => {
  switch (action.type) {
    ...
    case SET_MULTIMEDIA_AVISOS_PREVIEW:
      return { ...state, multimediaAvisosPreview: action.payload };
    case SET_ACTIVE_INICIAR_SESION_RESENA:
      return { ...state, activeIniciarSesionResena: action.payload };
    case SET_MODAL_RESENA:
      return { ...state, modalResena: action.payload };
    case SET_TYPE_USER_AUTH:
      return { ...state, typeUserAuth: action.payload };
    default:
      return state;
  }
};
